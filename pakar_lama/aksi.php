...
elseif($mod=='diagnosa_tambah'){
    ...
    elseif($db->get_row("SELECT * FROM tb_diagnosa WHERE kode_diagnosa='$kode'"))
        ...
        $db->query("INSERT INTO tb_diagnosa (kode_diagnosa, nama_diagnosa, solusi) VALUES ('$kode', '$nama', '$solusi')");                       
    ...
    if($kode=='' || $nama=='')
        ...
        $db->query("UPDATE tb_diagnosa SET nama_diagnosa='$nama', solusi='$solusi' WHERE kode_diagnosa='$_GET[ID]'");
        redirect_js("index.php?m=diagnosa");
    }
