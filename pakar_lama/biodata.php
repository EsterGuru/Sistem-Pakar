...
<form action="?m=daftar" method="post">
  ...
  <div class="form-group" style="width: 400px">
                <p style="color: #fff;" align="left"><b>NIK</b> <span class="text-danger">*</span></p>
                <input style="color: #000;" class="form-control" type="text" name="nik" required placeholder="Masukkan NIK" />
  </div>
