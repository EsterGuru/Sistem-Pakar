...
<body onLoad="window.print()">
  <table border="0" align="center">
     <tr> <td><p align="center" class="judul"><b>SISTEM PAKAR DIAGNOSA PENYAKIT STUNTING PADA BALITA DI KELURAHAN DANGA</b></p></td></tr>
...
<table width="1042" height="79" border="1" cellpadding="2" cellspacing="2">
  <tr>
    ...
    <td width="220" align="center" valign="middle"><b>NIK</b></td>
 ...
 require_once'functions.php';
    $q = esc_field($_GET['q']);
$rows = $db->get_results("SELECT DISTINCT nik,nama,no_hp,jk,alamat,tgl,hasil_konsultasi,kepercayaan FROM tb_hasil");
    $no=0;
