...
<html lang="en">
  <head>
    ...
    .hi{
background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url('Balita.png');
...
.latar{
  ...
  <body>
    ...
    <div class="container">
    <?php
        if(!$_SESSION['login'] && in_array($mod, array('diagnosa', 'gejala', 'relasi', 'rule')))
          $mod='home';
    ...
    <footer class="footer" style="background-color: #336699; color: #fff;">
      <div class="container">
       <span class="pull-right">
        <p>S1 Ilmu Komputer<i class="fa fa-heart pulse"></i> <b><a style="color: #fff" href="https://unwira.ac.id/" target="_blank"> UNWIRA KUPANG</a></b></p>
      </span>
      </div>
    </footer>
  </body>
